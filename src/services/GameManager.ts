...
export default class GameManager {
     ...
     */
    static save(currentStateName: string, stateData: unknown = {}): void {
    ...
    static load(): SavedState | null {
        ...
        try {
            ...
            return JSON.parse(savedData) as SavedState;
        } catch (error) {
     ...
     */
    static savePlayState(player1: any, player2: any): void {
     ...
     */
    static saveControlsScreen(): void {
     ...
     */
    static saveVictoryScreen(winnerName: string, player1Wins: number, player2Wins: number): void {
     ...
     * Saves just the wins
     */
    static saveWins(player1Wins: number, player2Wins: number): void {
        try {
            sessionStorage.setItem(
    ...
    static loadWins(): WinsSave {
        try {
            ...
            return JSON.parse(savedWins) as WinsSave;
        } catch (error) {
