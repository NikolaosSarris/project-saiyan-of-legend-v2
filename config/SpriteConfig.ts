...
export interface FighterSpriteConfig {
    idle: SpriteFrameConfig[];
    walk: SpriteFrameConfig[];
    jump: SpriteFrameConfig[];
    fall: SpriteFrameConfig[];
    death: SpriteFrameConfig[];
    block: SpriteFrameConfig[];
    damage: SpriteFrameConfig[];
    attack: SpriteFrameConfig[];
    special1: SpriteFrameConfig[];
}

export const gokuSpriteConfig: FighterSpriteConfig = {
...
export const vegetaSpriteConfig: FighterSpriteConfig = {
...
export function loadFighterSprites(spriteSheet: Graphic, spriteConfig: FighterSpriteConfig): Record<string, Sprite[]> {
    const sprites: Record<string, Sprite[]> = {};

    for (const [animationName, frames] of Object.entries(spriteConfig) as [string, SpriteFrameConfig[]][]) {
